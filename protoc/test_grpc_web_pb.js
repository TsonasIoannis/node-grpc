...
const proto = {};
proto.helloworld = require("./test_pb.js");
 ...
 * @final
 */
proto.helloworld.GreeterPromiseClient = function (
  hostname,
  credentials,
  options
) {
 ...
 */
proto.helloworld.GreeterClient.prototype.sayHello = function (
  request,
  metadata,
  callback
) {
 ...
 */
proto.helloworld.GreeterPromiseClient.prototype.sayHello = function (
  request,
  metadata
) {
