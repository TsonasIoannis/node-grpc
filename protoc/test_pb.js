...
goog.exportSymbol('proto.helloworld.LotsGreetingsResponse', null, global);
/**
 ...
 * @constructor
 */
proto.helloworld.LotsGreetingsResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.helloworld.LotsGreetingsResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.helloworld.LotsGreetingsResponse.displayName = 'proto.helloworld.LotsGreetingsResponse';
}
 ...
 * @return {!Object}
 */
proto.helloworld.LotsGreetingsResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.helloworld.LotsGreetingsResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.helloworld.LotsGreetingsResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.helloworld.LotsGreetingsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    evengreetings: jspb.Message.getFieldWithDefault(msg, 1, ""),
    oddgreetings: jspb.Message.getFieldWithDefault(msg, 2, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.helloworld.LotsGreetingsResponse}
 */
proto.helloworld.LotsGreetingsResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.helloworld.LotsGreetingsResponse;
  return proto.helloworld.LotsGreetingsResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.helloworld.LotsGreetingsResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.helloworld.LotsGreetingsResponse}
 */
proto.helloworld.LotsGreetingsResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      var value = /** @type {string} */ (reader.readString());
      msg.setEvengreetings(value);
      break;
    case 2:
      var value = /** @type {string} */ (reader.readString());
      msg.setOddgreetings(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.helloworld.LotsGreetingsResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.helloworld.LotsGreetingsResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.helloworld.LotsGreetingsResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.helloworld.LotsGreetingsResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getEvengreetings();
  if (f.length > 0) {
    writer.writeString(
      1,
      f
...
/**
 * optional string evenGreetings = 1;
 * @return {string}
 */
proto.helloworld.LotsGreetingsResponse.prototype.getEvengreetings = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.helloworld.LotsGreetingsResponse} returns this
 */
proto.helloworld.LotsGreetingsResponse.prototype.setEvengreetings = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional string oddGreetings = 2;
 * @return {string}
 */
proto.helloworld.LotsGreetingsResponse.prototype.getOddgreetings = function() {
 ...
 * @return {!proto.helloworld.LotsGreetingsResponse} returns this
 */
proto.helloworld.LotsGreetingsResponse.prototype.setOddgreetings = function(value) {
